    ...
    <main style={{ minHeight: '100vh', background: 'var(--dark-bg)', paddingTop: '150px', paddingBottom: '100px', position: 'relative' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 50px', position: 'relative', zIndex: 1 }}>
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} style={{ marginBottom: '60px' }}>
          <h1 className="text-massive" style={{ fontSize: '4rem', color: 'var(--text-light)', marginBottom: '20px' }}>Privacy <span style={{ color: 'var(--primary-red)' }}>Policy</span></h1>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4, duration: 1 }} style={{ color: 'var(--text-muted)', fontSize: '1.1rem', lineHeight: '1.8' }}>
          <h2 style={{ color: 'var(--text-light)', fontSize: '2rem', marginTop: '40px', marginBottom: '20px' }}>1. Data Collection</h2>
          ...
          <h2 style={{ color: 'var(--text-light)', fontSize: '2rem', marginTop: '40px', marginBottom: '20px' }}>2. Data Usage</h2>
          <p style={{ marginBottom: '20px' }}>
          ...
          <h2 style={{ color: 'var(--text-light)', fontSize: '2rem', marginTop: '40px', marginBottom: '20px' }}>3. Data Protection</h2>
          <p style={{ marginBottom: '20px' }}>
