...
# Fix Hero Section
hero_old = '''        {/* Illoca-Style Hero Section */}
...
hero_new = '''        {/* Illoca-Style Hero Section */}
...
# Fix Experience The Vision Button
vision_old = '''<motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="/about" className="btn-primary" style={{ padding: '15px 40px', fontSize: '1.1rem', border: 'none' }}>
              Explore About Us
            </motion.a>'''
vision_new = '''<motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="/about" style={{ padding: '15px 40px', fontSize: '1.1rem', border: 'none', background: '#0a0a0a', color: '#ffffff', borderRadius: '50px', textDecoration: 'none', fontWeight: 'bold' }}>
              Explore About Us
            </motion.a>'''
content = content.replace(vision_old, vision_new)

# Fix Impact Card Text Color
content = content.replace('style={{ fontSize: \'2.5rem\', marginBottom: \'5px\' }}>', 'style={{ fontSize: \'2.5rem\', marginBottom: \'5px\', color: \'#ffffff\' }}>')
